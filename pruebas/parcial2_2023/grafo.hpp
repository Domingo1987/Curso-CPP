...
*/
 ...
 // Desafios
	...
	virtual bool tieneCicloHamiltoniano();
	virtual bool hamiltonianoDFS(Estudiante, Estudiante, std::set<Estudiante>& visitados);

	virtual void DFSIsland(Estudiante vertex, std::set<Estudiante>& visited);
	virtual int contarIslas();

	//Segunda Prueba Parcial
  	virtual int contarBucles();
  	virtual Estudiante verticeConMayorGrado();
};